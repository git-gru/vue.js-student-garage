<template>
  <div>
    ...
    <!-- Header -->
  <header class="header text-white h-fullscreen" style="background-color: #24292e">
    ...
    <div class="container">
      <div class="row align-items-center h-100">
        ...
        <div class="col-md-5">
          ...
          <a class="btn btn-round btn-outline-light w-150" href="#">Learn more</a>
          <a class="btn btn-round btn-light w-150 ml-3" href="#">Sign up</a>
        </div>

        <div class="col-md-6 ml-auto">
          <img src="../../assets/img/preview/laptop-1.png" alt="img">
        </div>
